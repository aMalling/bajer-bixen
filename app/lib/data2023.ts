...
export const beerCalenderData: any = [
  ...
  {
    bryggeri: "Põhjala",
    navn: "More Than Amber (Cellar Series)\n",
    land: "EST",
    Alkohol: "13",
    brødtekst:
      "Vi har været der før og vi skal derhen igen: Til bryggeriet Põhjala fra Estland. De er knivskarpe i både stouts og portere. I dag står den på en fadlagret porter der har haft intet mindre end to år på cognacfade. \nVi synes at Põhjala's cellar-serie er en KÆMPE value-for-money-anbefaling. Så nu får I den første af årets fem mørke fadlagrede... og det er altså en PORTER! ",
    untappdlink:
      "https://untappd.com/b/dark-horse-brewing-co-bourbon-barrel-aged-plead-the-5th/34285",
    dato: "02",
  },
  {
    bryggeri: "Ārpus X Blood Brothers",
    navn: "Ārpus X Blood Brothers TDH Peacharine X Taiheke X Riwaka IPA\n",
    land: "LET/CAN",
    Alkohol: "6,5",
    brødtekst: "x",
    untappdlink:
  ...
  },
  {
    ...
    Alkohol: "13,1",
    brødtekst:
      "Sidste år øljulekalendermodtagere stiftede bekendtskab med amerikanske Short Throw Brewing Co. i form af en kettle sour med mango og abrikos. I år skal vi til et helt andet sted med STBC. En double pastry stout der har lagret med Vermont ahorn sirup, skumfiduser, ristet kokos, kanel og kaffebønner.\nEn klog mand sagde en dag: de bedste stouts i verden har lidt kanel i sig… nogle af de værste stouts i verden har lidt kanel i sig. \nVi håber at denne her rammer the sweet spot med sødme, bitterhed, kokos og kanelkrydder. ",
    untappdlink:
  ...
  },
  {
    ...
    Alkohol: "8",
    brødtekst:
      "En julebekendelse: beskrivelserne af øllene er ikke alle lavet før december. Ofte laves de løbende. Dagens er ingen undtagelse. Det har haft den betydning at forfatteren af denne tekst ved at den første Salikatt-øl, Killdozer, gik rent ind hos mange. Salikatts humlegame er så latterligt stærkt og det var en no-brainer at hive endnu en DIPA fra norge ind i årets lineup. \nSå værsgo’ til jer - from Norway with love. Endnu en formentlig voldsomt velafbalanceret DIPA! ",
