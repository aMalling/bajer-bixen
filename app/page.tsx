      ...
      <div className="relative flex justify-center ">
        ...
        <div className="bg-white rounded-lg shadow-xl md:absolute md:bg-opacity-30 border-0 flex flex-col justify-center md:grid gap-10 md:grid-cols-4 md:grid-rows-6 md:w-[862px] h-full p-10 ">
          ...
          >
            {!toggle1 && <div>1</div>}
            {toggle1 && (
              <OpenBeer calenderDate={{ dato: 1, top: "0px" }}> </OpenBeer>
            )}
          </div>
          <div
          ...
          >
            {!toggle2 && <div>2</div>}
            {toggle2 && (
              <OpenBeer calenderDate={{ dato: 2, top: "0px" }}> </OpenBeer>
            )}
          </div>
          <div
          ...
          >
            {!toggle3 && <div>3</div>}
            {toggle3 && (
              <OpenBeer calenderDate={{ dato: 3, top: "0px" }}> </OpenBeer>
            )}
          </div>{" "}
          <div
          ...
          >
            {!toggle4 && <div>4</div>}
            {toggle4 && (
              <OpenBeer calenderDate={{ dato: 4, top: "0px" }}> </OpenBeer>
            )}
          </div>
          <div
          ...
          >
            {!toggle5 && <div>5</div>}
            {toggle5 && (
              <OpenBeer calenderDate={{ dato: 5, top: "0px" }}> </OpenBeer>
            )}
          </div>
          <div
          ...
          >
            {!toggle6 && <div>6</div>}
            {toggle6 && (
              <OpenBeer calenderDate={{ dato: 6, top: "0px" }}> </OpenBeer>
            )}
          </div>
          <div
          ...
          >
            {!toggle7 && <div>7</div>}
            {toggle7 && (
              <OpenBeer calenderDate={{ dato: 7, top: "0px" }}> </OpenBeer>
            )}
          </div>
          <div
          ...
          >
            {!toggle8 && <div>8</div>}
            {toggle8 && (
              <OpenBeer calenderDate={{ dato: 8, top: "0px" }}> </OpenBeer>
            )}
          </div>
          <div
          ...
          >
            {!toggle9 && <div>9</div>}
            {toggle9 && (
              <OpenBeer calenderDate={{ dato: 9, top: "0px" }}> </OpenBeer>
            )}
          </div>
          <div
          ...
          >
            {!toggle10 && <div>10</div>}
            {toggle10 && (
              <OpenBeer calenderDate={{ dato: 10, top: "0px" }}> </OpenBeer>
            )}
          </div>
          <div
          ...
          >
            {!toggle11 && <div>11</div>}
            {toggle11 && (
              <OpenBeer calenderDate={{ dato: 11, top: "0px" }}> </OpenBeer>
            )}
          </div>
          <div
          ...
          >
            {!toggle12 && <div>12</div>}
            {toggle12 && (
              <OpenBeer calenderDate={{ dato: 12, top: "0px" }}> </OpenBeer>
            )}
          </div>
          <div
          ...
          >
            {!toggle13 && <div>13</div>}
            {toggle13 && (
              <OpenBeer calenderDate={{ dato: 13, top: "0px" }}> </OpenBeer>
            )}
          </div>
          <div
          ...
          >
            {!toggle14 && <div>14</div>}
            {toggle14 && (
              <OpenBeer calenderDate={{ dato: 14, top: "0px" }}> </OpenBeer>
            )}
          </div>
          <div
          ...
          >
            {!toggle15 && <div>15</div>}
            {toggle15 && (
              <OpenBeer calenderDate={{ dato: 15, top: "0px" }}> </OpenBeer>
            )}
          </div>
          <div
          ...
          >
            {!toggle16 && <div>16</div>}
            {toggle16 && (
              <OpenBeer calenderDate={{ dato: 16, top: "0px" }}> </OpenBeer>
            )}
          </div>{" "}
          <div
          ...
          >
            {!toggle17 && <div>17</div>}
            {toggle17 && (
              <OpenBeer calenderDate={{ dato: 17, top: "0px" }}> </OpenBeer>
            )}
          </div>
          <div
          ...
          >
            {!toggle18 && <div>18</div>}
            {toggle18 && (
              <OpenBeer calenderDate={{ dato: 18, top: "0px" }}> </OpenBeer>
            )}
          </div>
          <div
          ...
          >
            {!toggle19 && <div>19</div>}
            {toggle19 && (
              <OpenBeer calenderDate={{ dato: 19, top: "0px" }}> </OpenBeer>
            )}
          </div>
          <div
          ...
          >
            {!toggle20 && <div>20</div>}
            {toggle20 && (
              <OpenBeer calenderDate={{ dato: 20, top: "0px" }}> </OpenBeer>
            )}
          </div>{" "}
          <div
          ...
          >
            {!toggle21 && <div>21</div>}
            {toggle21 && (
              <OpenBeer calenderDate={{ dato: 21, top: "0px" }}> </OpenBeer>
            )}
          </div>
          <div
          ...
          >
            {!toggle22 && <div>22</div>}
            {toggle22 && (
              <OpenBeer calenderDate={{ dato: 22, top: "0px" }}> </OpenBeer>
            )}
          </div>{" "}
          <div
          ...
          >
            {!toggle23 && <div>23</div>}
            {toggle23 && (
              <OpenBeer calenderDate={{ dato: 23, top: "0px" }}> </OpenBeer>
            )}
          </div>
          <div
          ...
          >
            {!toggle24 && <div>24</div>}
            {toggle24 && (
              <OpenBeer calenderDate={{ dato: 24, top: "0px" }}> </OpenBeer>
            )}
          </div>
        </div>
      </div>
