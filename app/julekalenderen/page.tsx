...
export default function JuleKalenderen() {
    ...
    <main>
      <div className="relative my-10 flex justify-center ">
        ...
        <div className="absolute grid gap-10 grid-cols-4 grid-rows-6 w-[840px] h-full p-10 ">
          ...
          <div className="m-2  border-4 border-black bg-white cursor-pointer hover:opacity-100 text-center pt-5 opacity-20 border-dashed text-lg font-semibold">
            20
          </div>
          <div className="m-2  border-4 border-black bg-white cursor-pointer hover:opacity-100 text-center pt-5 opacity-20 border-dashed text-lg font-semibold">
            15
