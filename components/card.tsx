  ...
  return (
    <div>
      {new Date(`2023-11-${beerInfo.dato}`) <= new Date() ? (
        <div className="absolute md:fixed flex mx-3 flex-col w-[265px] md:mx-0 md:flex-row md:h-1/3 md:w-1/2 bg-white border-1 border-black z-10 mt-2 md:right-1/4 md:top-1/4 shadow-xl">
